...
| Tool activity cards | Action lifecycle events update existing compact tool cards without duplicate status rows | `tests/test_web.py` |
...
- Good: assert tool-card de-duplication helpers when changing event rendering.
