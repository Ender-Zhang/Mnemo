...
- Tool approval cards reuse the same inline Decision Card renderer and should show only compact tool metadata.
...
| Tool approval card | Denied external/admin tool calls project through the existing decision card path | `tests/test_runtime.py` |
