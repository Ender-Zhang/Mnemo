...
class MemoryMcpServer:
    ...
    def call_tool(self, name: str, arguments: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        handlers = {
            ...
            "mnemo_memory_ingest_event": lambda: self.client.ingest_event(
                text=_required(args.get("text"), "text"),
                source=_string(args.get("source"), "mcp"),
                actor=_optional(args.get("actor")),
                event_type=_string(args.get("event_type"), "message"),
                context=_list(args.get("context")),
                run_id=_optional(args.get("run_id")),
                mission_id=_optional(args.get("mission_id")),
                conversation_id=_optional(args.get("conversation_id")),
                message_id=_optional(args.get("message_id")),
                agent_id=_optional(args.get("agent_id")),
                scope=_optional(args.get("scope")),
